...
def predict_result(data_):
	check_input_data(data_)
	print(make_boolean_features(data_))
	print(make_numeric_features(data_))
	#print(scale_features(make_numeric_features(data_), open_scaler('scaler.pkl')))
	scaled_X = scale_features(make_numeric_features(data_), open_scaler('scaler.pkl'))
	X_pred = concatenate_features(make_boolean_features(data_), scaled_X)
	print(X_pred)
